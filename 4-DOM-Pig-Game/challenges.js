// a player looses his entire score if he rolls two 6 in a row. after that its the next player turn(always save the previous dice roll in a separate variable)
...
function nextPlayer(){
    ...
    activePlayer===0?activePlayer=1:activePlayer=0;  
        roundScore=0;//ternary operator is used
